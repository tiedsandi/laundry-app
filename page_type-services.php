                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center py-4">
                                <h5 class="card-title">Tabel Servis</h5>
                                <a href="add_edit_type-services.php" class="btn btn-primary">Tambah Servis</a>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-success btn-sm" href="add_edit_type-services.php?idEdit=<?php echo $row['id'] ?>">Edit</a>
                                                    <?php if($row['deleted_at'] == '0000-00-00 00:00:00' || empty($row['deleted_at'])) :?>
                                                        <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin delete ?')" href="page_type-services.php?delete=<?php echo $row['id'] ?>">Delete</a>
                                                    <?php endif ?>
                                                </td>
                                            </tr>
